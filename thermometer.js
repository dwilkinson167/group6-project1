// https://codepen.io/davidbanks/pen/rksLn
function thermometerF(tempId){

var stripVar = tempId.replace( "#", "");

var elInput = parseFloat(document.getElementById(stripVar).childNodes[1].innerHTML);
...
var width = 80,
    ...
    if(stripVar == 'thermo-c'){
      maxTemp = 100;
    }else if (stripVar == 'thermo-k') {
      maxTemp = 375;
      minTemp = 235;
    }else {
...
thermometerF('#thermo-f');
thermometerF('#thermo-c');
thermometerF('#thermo-k');
